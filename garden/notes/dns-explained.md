...
Privacy advice often includes "change your DNS to 1.1.1.1 or 8.8.8.8" without explaining what this changes or why. Every time you visit a domain, your computer has to translate that name into an address first. That step is DNS, and by default it is one of the more exposed things you do online. What it is, who can see it, and whether "just switch to 1.1.1.1" actually helps:
...
Default DNS: your ISP sees every domain you visit, in plain text, and can legally log and sell it.
