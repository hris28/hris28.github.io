...
[Tor](https://www.torproject.org/) is open-source software that routes your traffic through a chain of volunteer-run servers before it reaches the destination. It was originally built by the [US Naval Research Laboratory](https://en.wikipedia.org/wiki/United_States_Naval_Research_Laboratory) in the 1990s to protect government communications, then released publicly.
