...
> **Common misconception:** VPN advertisements often claim HTTPS provides "military-grade encryption." This is accurate for the content of the connection, but can be misleading as a complete description of what HTTPS hides. Your ISP *cannot* read your messages or see your passwords. Your ISP *can* see that you visited a site, when you visited it, and approximately how much data you exchanged.

---

## Layer 3: [DNS](dns-explained.md) and what changing it does
